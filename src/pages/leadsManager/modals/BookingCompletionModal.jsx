...
const BookingCompletionModal = ({ lead, onClose, onSave }) => {
  ...
  const handleSave = () => {
    const interaction = {
      ...
      note: notes || "Booking completed successfully",
      bookingDate,
      bookingTime
    };
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-96 max-h-[90vh] overflow-y-auto">
        <h3 className="text-lg font-semibold mb-4">Booking Completion</h3>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Enter booking details and notes..."
            />
          </div>

          <div>
            <label className="block text-sm font-medium mb-1">Follow-up Date & Time (Optional)</label>
            <div className="flex gap-2">
              <input
                type="date"
                value={followupDate}
...
export default BookingCompletionModal;